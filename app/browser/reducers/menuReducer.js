...
let {appMenu, closedFrames, lastClosedUrl} = require('../menu')
    ...
    case windowConstants.WINDOW_SET_FOCUSED_FRAME:
      {
        ...
        if (frame) {
          let currentLocation = frame.location
          setMenuItemChecked(state, locale.translation('bookmarkPage'), isCurrentLocationBookmarked(state, currentLocation))
        }
        break
      }
